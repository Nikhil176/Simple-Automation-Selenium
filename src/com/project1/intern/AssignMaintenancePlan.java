 ...
 * @author krishnva
 */
public class AssignMaintenancePlan {
	
	AssignMaintenancePlan() throws InterruptedException
	{
		...
		{
			if( (c_list.get(i).getText()).equals("Assign survey area"))
			{
				k = i;
			}
		}
		...
		Variables.driver_v.findElement(By.id("userSelect")).sendKeys(Variables.normal_user_v);
